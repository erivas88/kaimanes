    ...
    <body>
        <div class="main-container">
            ...
            <div class="header d-flex justify-content-between align-items-center px-3" style="background-color: white; padding: 10px 0;">
                ...
                <nav class="d-flex">
                    <a href="#" class="text-dark text-decoration-none mx-2">Mapa</a>
            ...
            <nav class="d-flex align-items-center px-4 py-3" style="background: linear-gradient(to right, #02697e, #3e98a6);">
                <a href="#" class="text-white text-decoration-none mx-1 fw-bold">Sistema de Monitoreo de Aguas Valle Pupío</a>
            </nav>
                    ...
                    <div class="col-md-3">
                        <div class="panel">
                            <div style="background-color: #f5f5f5; padding: 15px 10px 0 10px;">
                                <h5 class="fw-bold title_pop">Explorar</h5>
                                <hr style="width: 100%;" />
                            </div>
                            <div id="side" style="background-color: #f5f5f5;"></div>
                        </div>
                    </div>
                    <div class="col-md-9">
                        <div class="panel">
                            <div style="background-color: transparent; padding: 15px 10px 0 10px;">
                                <h5 class="fw-bold title_pop">
                                    <span class="title_reply" style="color: #555555;" id="sectorView"><span style="color: transparent;">.</span></span>
                                </h5>
                                <hr />
                            </div>
