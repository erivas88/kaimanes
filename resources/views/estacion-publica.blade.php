                                ...
                                <div style="margin-left: 0px; margin-right: 10px;">
                                    ...
                                    <div style="margin-left: 10px; margin-right: 10px; background-color: #eee;">
                                        ...
                                        <p class="ultima-nota" style="font-size: 13px; color: #949494; margin-bottom: 20px; line-height: 170%; font-family: 'Poppins', serif; text-align: justify; padding: 20px;">
                                            ...
                                            <span class="title_legend">Nota :</span>
                                            <span class="subtitle">
                                                la información de monitoreo disponible está sujeta a las condiciones de conectividad y telecomunicaciones en la zona. La ejecución de mantenciones en los equipos y/o algún otro evento pueden
                                                alterar momentáneamente los registros. Para mayores detalles ver sección "Observaciones"
                                            </span>
                                        </p>
                                        ...
                                        <div class="stats-container" style="display: flex; justify-content: space-around; margin-top: 10px; padding: 10px; font-family: 'Poppins';"></div>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="modal fade" id="welcome" tabindex="-1" aria-labelledby="miModalLabel">
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        ...
                        <div class="modal-body" style="font-weight: normal !important; font-size: 12px;" ;></div>
                        <div class="modal-footer">
                            <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cerrar</button>
                        </div>
                    </div>
